...
async function sendTelegramNotification(type, ip, add_data = "") {
    ...
    // 构建 Telegram API 请求的 URL
    const url = `https://api.telegram.org/bot${BOT_TOKEN}/sendMessage?chat_id=${CHAT_ID}&parse_mode=HTML&text=${encodeURIComponent(msg)}`;
